...
public class RVCourse extends RecyclerView.Adapter<RVCourse.RVholder>{
        DBHelperCourse DbCourseApp;
        Context context;
        ArrayList<Course> data = new ArrayList<>();

        public RVCourse(Context con, ArrayList<Course> data) {
            this.context = con;
            this.data = data;
        }
        ...
        public void onBindViewHolder(@NonNull RVholder holder, int position) {
            holder.Title.setText(data.get(position).getCourseCode());
            holder.ViewDetails.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(v.getContext(), CourseForm.class);
            ...
            holder.Delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DbCourseApp = new DBHelperCourse(v.getContext());
                    boolean check = DbCourseApp.deleteData(data.get(position).getId());
                    if (check)
